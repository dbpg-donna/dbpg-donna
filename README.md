...
### Hinweise zu KI-generiertem Code

| | |
|---|---|
| **Immer reviewen** | KI-generierter Code kann Fehler, Sicherheitslücken oder subtile Logikprobleme enthalten. |
| **Nicht blind vertrauen** | Jeder Commit mit KI-Beteiligung wurde von einem Menschen geprüft, aber zusätzliche Reviews sind empfohlen. |
| **Keine Garantie** | KI-generierter Code wird ohne Gewährleistung bereitgestellt. Die Verantwortung liegt beim Entwickler, der den Code merged. |
| **Kontext beachten** | KI arbeitet mit dem Wissen zum Zeitpunkt des Trainings. Aktuelle Best Practices, Sicherheitspatches oder API-Änderungen könnten fehlen. |
...
| | |
|---|---|
| **Always review** | AI-generated code may contain errors, security vulnerabilities, or subtle logic issues. |
| **Do not blindly trust** | Every commit with AI involvement was reviewed by a human, but additional reviews are recommended. |
| **No warranty** | AI-generated code is provided as-is. Responsibility lies with the developer who merges the code. |
| **Consider context** | AI operates with knowledge available at training time. Current best practices, security patches, or API changes may be missing. |
